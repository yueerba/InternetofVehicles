...
public class BNDemoMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bandemo_guide);
        ...
        latLngResult = intent.getParcelableExtra("latLngResult");
        Toast.makeText(BNDemoMainActivity.this, latLngMain.latitude + "" + latLngResult.latitude, Toast.LENGTH_SHORT).show();
